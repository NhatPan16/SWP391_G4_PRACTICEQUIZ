...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                .antMatchers("/", "/register/**", "/login","/quiz-list","/search-quizzes/**", "/expert", "/home", "/css/**", "/js/**", "/images/**","/blog-detail/**", "/about","/resetpassword/**","/blog-list","/blogs/").permitAll() // Cho phép truy cập vào tài nguyên tĩnh
